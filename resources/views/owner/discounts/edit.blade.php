                ...
                <form action="{{ route('owner.discounts.update', $discount->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('category_discount_id') is-invalid @enderror" id="category_discount_id" name="category_discount_id">
                            ...
                            <option value="{{ $category->id }}" {{ old('category_discount_id', $discount->category_discount_id) == $category->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ old('start_date', $discount->start_date) }}" />
                        @error('start_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" value="{{ old('end_date', $discount->end_date) }}" />
                        @error('end_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="text-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            ...
                            <span class="d-none d-sm-block">Update Discount</span>
                        </button>
                    </div>
                </form>
            </div>
